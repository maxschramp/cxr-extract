"""Core CXR file representation and parsing."""
...
class CXRFile:
    """Represents a Corona CXR file with metadata and render elements."""
    
    def __init__(self, filename: str, directory_path: str, frame_number: int, 
                 sequence_name: str, elements: Optional[List[str]] = None):
    ...
    def _parse_corona_elements(elements_string: str) -> List[str]:
        ...
        for part in elements_string.split('", "'):
